...
public class Poligono extends JFrame  {
	...
	private int[] Pontos_x = {200, 200, 250, 270, 300};/*cordenadas x dos vertices*/
	   private int[] Pontos_y = {300, 200, 250, 200, 300};/*cordenadas y dos vertices*/
	   private int Pontos_n = 5;/*numero de vertice*/
